...
const ConsumedLineChart = ({ wdata }) => {
  ...
  useEffect(() => {
    ...
    const labelsArray = Object.keys(monthUnitsMap).sort(
      (a, b) =>
        new Date(Date.parse(a + " 1, 2020")) -
        new Date(Date.parse(b + " 1, 2020"))
    );
...
export default ConsumedLineChart;
